...
class Admin:
    ...
    def admin_mainmenu(self,a,b):
         self.mainframe = LabelFrame(self.mainw, width=1200, height=145,bg="#FF9F9F")
         ...
         self.formframe = Frame(self.mainw, width=500, height=550, bg="#FFADBC")
         ...
         self.itemframe = Frame(self.mainw, bg="#FFADBC", width=600, height=300)
         self.itemframe.place(x=420, y=280, anchor=NW)
         self.itemframeinfo=self.itemframe.place_info()
         self.formframe1 = Frame(self.mainw, width=500, height=445, bg="#FFADBC")
         self.formframe1.place(x=100,y=275)
         self.formframe1info = self.formframe1.place_info()
         self.searchframe = Frame(self.mainw, width=720, height=70, bg="#FFADBC")
         self.searchframe.place(x=575, y=260)
         self.searchframeinfo = self.searchframe.place_info()
         self.searchbut = Button(self.searchframe, text="Search Description", font="roboto 14", bg="#FFADBC", bd=5, command=self.searchprod)
         self.searchbut.place(x=0, y=20, height=40)
         self.searchvar=StringVar()
         self.searchentry = myentry(self.searchframe, textvariable=self.searchvar, font="roboto 14", width=25, bg="#FFADBC")
         ...
         self.resetbut = Button(self.searchframe, text="Reset", font="roboto 14", bd=5, width=8, bg="#FF9F9F", command=self.resetprodtabel)
    ...
    def buildprodtable(self):
         ...
         for i in range(0,6):
             Label(self.formframe, text=l1[i], font="roboto 14 bold", bg="#FF9F9F").place(x=0, y=va)
             va += 60
         ...
         Button(self.formframe, text="Update", font="robot 11 bold",bg="#FF9F9F", bd=5, width=10, height=2,
         command=self.changeprodtable).place(x=105, y=361)
         Button(self.formframe, text="Remove", font="robot 11 bold",bg="#FF9F9F", bd=5, width=10, height=2,
    ...
    def additems(self):
        ...
        for i in range(0,len(l)):
            Label(self.itemframe,text=l[i],font="Roboto 14 bold",bg="#FF9F9F").grid(row=i,column=0,pady=15,sticky="w")
        ...
        Button(self.itemframe,text="Add item",height=3,bd=6,command=self.insertitem,bg="#FF9F9F").grid(row=6,column=1,pady=10,padx=12,sticky="w",ipadx=10)
        Button(self.itemframe, text="Back", height=3,width=8, bd=6,command=self.buildprodtable,bg="#FF9F9F").grid(row=6, column=1,padx=16, pady=10,sticky="e",ipadx=10)
    ...
    def buildusertable(self):
         ...
         for i in range(0,3):
             Label(self.formframe1, text=l1[i], font="roboto 14 bold", bg="#FF9F9F").place(x=0, y=va)
             va += 70
         ...
         Button(self.formframe1, text="Create a User", font="robot 12 bold", bg="#FF9F9F", bd=5, width=12, height=2,
                command=self.adduser).place(x=0, y=10)
         Button(self.formframe1, text="Update", font="robot 12 bold", bg="#FF9F9F", bd=5, width=10, height=2,
                command=self.changeusertable).place(x=145, y=381)
         Button(self.formframe1, text="Remove", font="robot 12 bold", bg="#FF9F9F", bd=5, width=10, height=2,
