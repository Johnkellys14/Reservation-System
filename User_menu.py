...
class User:
    ...
    def user_mainmenu(self,a,b):
        self.mainframe = LabelFrame(self.mainw, width=800, height=140, bg="#FF9F9F")
        self.mainframe.place(x=330, y=120)
        mi = PhotoImage(file="images/items.png")
        mi = mi.subsample(a, b)
        self.aitems = Button(self.mainframe, text="Items",bd=5,font="roboto 11 bold",bg="#FFFFFF", image=mi, compound=TOP,command=self.builditemtable)
        self.aitems.image = mi
        self.aitems.place(x=260, y=17)
        mi = PhotoImage(file="images/invoice2.png")
        mi = mi.subsample(a,b)
        self.aitems = Button(self.mainframe, text="Invoice",bd=5,bg="#FFFFFF",font="roboto 11 bold", image=mi, compound=TOP,command=self.make_invoice)
        self.aitems.image = mi
        self.aitems.place(x=62, y=17)
        mi = PhotoImage(file="images/change1.png")
        mi = mi.subsample(a, b)
        self.changeuser = Button(self.mainframe, text="Sign out",bd=5,bg="#FFFFFF",font="roboto 11 bold", image=mi, compound=TOP)
        self.changeuser.image = mi
        self.changeuser.place(x=460, y=17)
        mi = PhotoImage(file="images/Door_Out-512.png")
        mi = mi.subsample(a, b)
        self.logout = Button(self.mainframe, text="Quit",bd=5,bg="#FFFFFF",font="roboto 11 bold", image=mi, compound=TOP)
        ...
        self.entryframe1 = Frame(self.mainw, width=500, height=350, bg="#FFADBC")
    ...
    def user_input(self):
       ...
       Button(self.entryframe,text="Proceed",command=self.transtableadd,bd=10,width=8,height=7,bg="#FF9F9F",font="roboto 10").place(x=0,y=30)
       Button(self.entryframe, text="Add to cart", command=self.addtotrans, bd=10, width=10, height=3,bg="#FF9F9F",font="roboto 10").place(x=100,y=80)
       Button(self.entryframe, text="Remove", command=self.removecart, bd=10, width=10, height=3, bg="#FF9F9F",font="roboto 10").place(x=210, y=80)
       ...
       va=0
       for i in range(0,4):
           Label(self.entryframe1, text=li[i], font="roboto 14 bold", bg="#CE7777").place(x=0, y=va)
           va += 65
