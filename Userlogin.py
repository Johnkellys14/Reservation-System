...
class Login:
    ...
    # WIDGET FUNCTION
    def obj(self):
        self.loginframe=LabelFrame(self.loginw,bg="#CE7777",height=400,width=300)
        self.loginw.bind('<Return>',self.checkuser)
        self.loginframe.place(x=103,y=95)
        self.toplabel = Label(self.loginframe, fg="white", bg="#CE7777", anchor="center", text="Login", font="Roboto 40 bold")
        ...
        self.signin = Button(self.loginframe,width=20, text="Sign in",bg="#FFFFFF",fg="#000000",command=self.checkuser,font="Roboto 14")
