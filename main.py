...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="#CE7777")
        self.topframe.place(x=0,y=0)
        self.store_name = 'BAO Reservation'
        self.storelable=Label(self.topframe,text=self.store_name + "'s Sales & Inventory System",bg="#CE7777",anchor="center")
